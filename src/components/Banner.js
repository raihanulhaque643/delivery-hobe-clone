...
const Banner = () => {
    return (
        <div className="flex flex-row justify-between items-center my-4 mx-8 w-auto h-28 rounded-lg bg-cover bg-center px-4" style={{'background-image': "url('https://media.giphy.com/media/iF38ziTbss8j6/giphy.gif')" }}>
